...
atomic_color_map = {'Ac': (0.39344, 0.62101, 0.45034),
...
def quick_plot_uks(pdos_dir, style = 0, replace_dict = None):
    ...
    for pdosobj in data['ALPHA']:
        true_element = get_true_element(pdosobj=pdosobj, replace_dict=replace_dict)
        l1, label = plot_single_pdos(pdosobj, ax, true_element, spin=1, raw=raw)
    ...
    ax.text(0.05, 0.8, "ALPHA", ha="left", va="center", transform=ax.transAxes,)
