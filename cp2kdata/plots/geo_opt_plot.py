...
def geo_opt_info_plot(geo_opt_info, dst):
    ...
    ax_max_step.hlines(geo_opt_info()[-1]["limit_step_size"], 0, geo_opt_steps[-1], color='lightcoral', ls='dashed')
    ...
    ax_rms_step.hlines(geo_opt_info()[-1]["limit_rms_step"], 0, geo_opt_steps[-1], color='lightcoral', ls='dashed')
    ...
    ax_max_grad.hlines(geo_opt_info()[-1]["limit_gradient"], 0, geo_opt_steps[-1], color='lightcoral', ls='dashed')
    ...
    ax_rms_grad.hlines(geo_opt_info()[-1]["limit_rms_gradient"], 0, geo_opt_steps[-1], color='lightcoral', ls='dashed')
